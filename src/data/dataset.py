...
class MRIVolumeDataset(Dataset):
    ...
    def _cache_path(self, nifti_path: str) -> str:
        # stable short name per subject + settings
    ...
    def _load_registered(self, path: str) -> np.ndarray:
    ...
    def __getitem__(self, idx):
        path, y = self.samples[idx]
        vol = self._load_registered(path)
